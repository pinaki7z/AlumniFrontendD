...
const PhotoGallery = () => {
  ...
  const fetchDepartmentsAndImages = async () => {
    ...
    try {
      ...
      const response = await axios.get(`${import.meta.env.VITE_API_URL}/images/getGoogleDriveFolders`);
      ...
      for (const folder of folderData) {
        ...
        if (department === selectedDepartment || !selectedDepartment) { // Filter by department if selected
          const imageResponse = await axios.post(`${import.meta.env.VITE_API_URL}/images/getImagesFromFolder`, { folderLink: link });
  ...
  const handleUploadSubmit = async (e) => {
    e.preventDefault();
    try {
      await axios.post(`${import.meta.env.VITE_API_URL}/uploadGoogleDrive`, {
