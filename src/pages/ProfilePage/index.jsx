  ...
  return (
    <div className="container mx-auto p-4 space-y-3">
      ...
      <div className="relative rounded-lg overflow-hidden shadow-lg">
        ...
        <button onClick={() => document.getElementById('coverInput').click()} className="absolute top-4 right-4 bg-white px-4 py-2 rounded-full text-sm font-medium hover:bg-gray-100">Edit Cover</button>
      ...
      <div className="relative bg-white rounded-lg shadow-lg -mt-24 pt-24 pb-6 px-6">
        ...
        <div className="text-center mt-4">
          <h2 className="text-2xl font-bold flex items-center justify-center space-x-2">
            ...
            {profile.validated && <HiMiniCheckBadge className="text-blue-500 w-6 h-6" />}
          </h2>
            ...
            <div className="p-4">
              ...
              <ul className="space-y-2 text-gray-700">
                ...
                <li className="flex items-center space-x-2">
                  ...
                  {profile.workExperience?.length ? `Workplace: ${findCurrentWorkingAt()}` : <Link to='/home/profile/profile-settings' className="underline">Add your workplace</Link>}
                </li>
                {/* Country */}
                <li className="flex items-center space-x-2">
